...
- name: Google Cloud SQL API Add Projects Project Instances Instance Databases
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/databases/master/_listings/google-cloud-sql/projects-project-instances-instance-databases-post.md
x-common:
- type: x-change-log
