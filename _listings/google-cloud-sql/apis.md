...
- name: Google Cloud SQL API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/databases/master/_listings/google-cloud-sql/projects-project-instances-instance-databases-database-patch.md
x-common:
- type: x-change-log
